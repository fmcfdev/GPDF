...
(function () {
  ...
  const GS_WASM_LOCATE_FILE = (file) =>
  ...
  processServerBtn.addEventListener("click", () => {
    alert(
      "O processamento em servidor está em desenvolvimento. Por favor, use o processamento local por enquanto.",
    );
  });
  ...
  async function initGS() {
    ...
    document.getElementById("loaderTitle").textContent =
      "Carregando motor de compressão...";
  ...
  processBtn.addEventListener("click", async () => {
    ...
    try {
      ...
      try {
        ...
        throw new Error(
          "O Ghostscript não conseguiu gerar o arquivo de saída. Verifique se o PDF não possui proteção por senha.",
        );
      }
      ...
      alert(
        error.message ||
          "Ocorreu um erro ao comprimir o arquivo. Tente novamente.",
      );
    }
  });
})();
